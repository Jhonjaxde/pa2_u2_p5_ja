...
@Entity
@Table(name = "libro")
//nombre de la entidad.nombreDistintivo,consulta en JPQL
...
public class Libro {
	...
	joinColumns = @JoinColumn(name = "auli_id_libro"),//nombre tabla secundaria
	inverseJoinColumns = @JoinColumn(name = "auli_id_autor"))//nombre tabla principal
